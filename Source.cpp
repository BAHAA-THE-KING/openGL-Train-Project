...
int InitGL(GLvoid) // All Setup For OpenGL Goes Here
{
   ...
   light=LoadTexture("images/wood.bmp");
   brick=LoadTexture("images/brick.bmp");
    grid =LoadTexture("images/wall.bmp");
  sky=LoadTexture("images/skybox.bmp");
  // cactus=LoadTexture("images/cactus.bmp");
    ds = new tunnel(Point(0, -5,0), 30,100,40,-3, grid, dune, brick,light);
    skybox = SkyBox(Point(0,0,0), 750, 1000, 500, sky);
   ...
   int nCmdShow) // Window Show State
{
   ...
   UINT timer=SetTimer(hWnd,0,0,(TIMERPROC)NULL);//0,50
